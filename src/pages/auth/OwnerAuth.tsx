...
import { ArrowLeft, Crown, Loader2, Eye, EyeOff, Zap, CheckCircle2 } from "lucide-react";
            ...
            {screen === "forgot" ? (
              resetSent ? (
                ...
                <form onSubmit={handleForgotPassword} className="space-y-4">
                  ...
                  <Button type="submit" disabled={loading} className="w-full bg-gradient-to-r from-amber-500 to-orange-600 text-white border-0 hover:opacity-90 h-11 font-semibold">
